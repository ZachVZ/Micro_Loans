...
print(f"future value $ {future_value} and the # of remaining months {remaining_months}")
...
present_value1 = loan.get("future_value") / (1+loan.get("annual_discount_rate")/12)**loan.get("remaining_months")
print(f"present value $ {present_value :.2f}")
print(f"present value $ {present_value1 :.2f}")
...
Output this list of inexpensive loans to a csv file
    1. Use `with open` to open a new CSV file.
        ...
        c. Use a for loop to iterate through each loan in `inexpensive_loans`. for loan in inexpensive_loans
...
print("writing the data to a csv file")
 #open the output csv filw path using with open
...
#create new file
csvpath = Path("inexpensive_loans.csv")
print("writing the data tio a csv file")
